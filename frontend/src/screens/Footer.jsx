...
const Footer = () => {
   {
    return (
      <div className=''>
        <h1 className='font-extrabold text-5xl pl-20'>OUR HAPPY CUSOTMERS</h1>
        <div className='h-80 cursor-pointer flex justify-center items-center' >
        ...
        <section className='pl-20 pr-20' data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1000">
          <div className='w-full h-45 bg-black rounded-2xl flex items-center pl-10 pr-10'>
            <h1 className='text-white text-5xl font-extrabold w-[60%]'>STAY UPTO DATE ABOUT OUR LATEST OFFERS</h1>
            <div className='flex flex-col w-[40%]'>
              <div className='bg-white w-[100%] h-10 flex items-center rounded-2xl'>
                <i class="fa-regular fa-envelope pl-3"></i>
        ...
        <section className='list-none grid grid-cols-5 mt-10 p-4 ml-20'>
